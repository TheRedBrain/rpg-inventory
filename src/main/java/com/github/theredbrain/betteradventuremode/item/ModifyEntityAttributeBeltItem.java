...
public class ModifyEntityAttributeBeltItem extends AccessoryTrinketItem {
    private final EntityAttribute attribute;
    private final String modifierName;
    private final double amount;
    private final EntityAttributeModifier.Operation operation;
    public ModifyEntityAttributeBeltItem(EntityAttribute attribute, String modifierName, double amount, EntityAttributeModifier.Operation operation, Identifier assetSubpath, Settings settings) {
