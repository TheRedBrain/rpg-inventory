...
public class BlockRegistry {
    ...
    public static final Block CRAFTING_TAB_0_PROVIDER_BLOCK = registerBlock("crafting_tab_0_provider_block", new CraftingTabProviderBlock(0, FabricBlockSettings.create().mapColor(MapColor.OAK_TAN)), ItemGroupRegistry.BAM_BLOCK);
