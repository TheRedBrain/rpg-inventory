...
public class ItemRegistry {
    ...
    public static final Item ADDITIONAL_FIRE_DAMAGE_RING = registerItem("additional_fire_damage_ring", new ModifyEntityAttributeRingItem(EntityAttributesRegistry.ADDITIONAL_FIRE_DAMAGE, "additional_fire_damage", 4.0, EntityAttributeModifier.Operation.ADDITION, BetterAdventureMode.identifier("model/accessory/ring_basic"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item MAX_EQUIPMENT_WEIGHT_RING = registerItem("max_equipment_weight_ring", new ModifyEntityAttributeRingItem(EntityAttributesRegistry.MAX_EQUIPMENT_WEIGHT, "max_equipment_weight", 0.5, EntityAttributeModifier.Operation.MULTIPLY_TOTAL, BetterAdventureMode.identifier("model/accessory/ring_basic"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item KEEP_INVENTORY_ON_DEATH_RING = registerItem("keep_inventory_on_death_ring", new AccessoryTrinketItem(BetterAdventureMode.identifier("model/accessory/ring_basic"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item CALAMITY_RING = registerItem("calamity_ring", new AccessoryTrinketItem(BetterAdventureMode.identifier("model/accessory/ring_basic"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item ARCHER_RING = registerItem("archer_ring", new AccessoryTrinketItem(BetterAdventureMode.identifier("model/accessory/ring_basic"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item ARCANE_BLAST_SPELL_BOOK = registerSpellContainerItem("arcane_blast_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("arcane_blast"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("wizards:arcane_blast"));
    public static final Item ARCANE_BOLT_SPELL_BOOK = registerSpellContainerItem("arcane_bolt_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("arcane_bolt"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("wizards:arcane_bolt"));
    public static final Item ARCANE_MISSILE_SPELL_BOOK = registerSpellContainerItem("arcane_missile_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("arcane_missile"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("wizards:arcane_missile"));
    public static final Item FIRE_BREATH_SPELL_BOOK = registerSpellContainerItem("fire_breath_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("fire_breath"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("wizards:fire_breath"));
    ...
    public static final Item FIRE_SCORCH_SPELL_BOOK = registerSpellContainerItem("fire_scorch_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("fire_scorch"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("wizards:fire_scorch"));
    public static final Item FIREBALL_EXPLOSIVE_SPELL_BOOK = registerSpellContainerItem("fireball_explosive_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("fireball_explosive"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("betteradventuremode:fireball_explosive"));
    public static final Item FIREBALL_SPELL_BOOK = registerSpellContainerItem("fireball_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("fireball"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("betteradventuremode:fireball"));
    public static final Item FROSTBOLT_SPELL_BOOK = registerSpellContainerItem("frostbolt_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("frostbolt"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("wizards:frostbolt"));
    public static final Item FROST_NOVA_SPELL_BOOK = registerSpellContainerItem("frost_nova_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("frost_nova"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("wizards:frost_nova"));
    ...
    public static final Item ICE_LANCE_SPELL_BOOK = registerSpellContainerItem("ice_lance_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("ice_lance"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("wizards:ice_lance"));
    ...
    public static final Item FLASH_HEAL_SPELL_BOOK = registerSpellContainerItem("flash_heal_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("flash_heal"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("paladins:flash_heal"));
    public static final Item HEAL_SPELL_BOOK = registerSpellContainerItem("heal_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("heal"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("paladins:heal"));
    public static final Item HOLY_BEAM_SPELL_BOOK = registerSpellContainerItem("holy_beam_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("holy_beam"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("paladins:holy_beam"));
    public static final Item HOLY_SHOCK_SPELL_BOOK = registerSpellContainerItem("holy_shock_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("holy_shock"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("paladins:holy_shock"));
    public static final Item JUDGEMENT_SPELL_BOOK = registerSpellContainerItem("judgement_spell_book", new SpellBookTrinketItem(BetterAdventureMode.identifier("judgement"), new FabricItemSettings().maxCount(1)), ItemGroupRegistry.BAM_EQUIPMENT, List.of("paladins:judgement"));
    // endregion Spells
    ...
    public static final Item BATTLE_AXE = registerItem("battle_axe", new BasicWeaponItem(DamageTypesRegistry.BATTLE_AXE_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.BATTLE_AXE_TWO_HANDED_DAMAGE_TYPE, 8, -3.5F, 2, 1.25F, 4, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item CLAW = registerItem("claw", new BasicWeaponItem(DamageTypesRegistry.CLAW_DAMAGE_TYPE, 3, -2.0F, 0.5F, 1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item DAGGER = registerItem("dagger", new BasicWeaponItem(DamageTypesRegistry.DAGGER_DAMAGE_TYPE, 3, -2.0F, 0.5F, 1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    // TODO knuckles
    public static final Item HALBERD = registerItem("halberd", new BasicWeaponItem(DamageTypesRegistry.HALBERD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.HALBERD_TWO_HANDED_DAMAGE_TYPE, 7, -3.0F, 1.75F, 1.0F, 3, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item LONG_SWORD = registerItem("long_sword", new BasicWeaponItem(DamageTypesRegistry.LONG_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.LONG_SWORD_TWO_HANDED_DAMAGE_TYPE, 5, -2.4F, 1.25F, 0.5F, 2, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item MACE = registerItem("mace", new BasicWeaponItem(DamageTypesRegistry.MACE_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.MACE_TWO_HANDED_DAMAGE_TYPE, 5, -2.4F, 1.0F, 0.5F, 2, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD = registerItem("short_sword", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 5, -2.4F, 1.0F, 0.5F, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_1 = registerItem("short_sword_plus_1", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 6, -2.4F, 1.0F, 0.5F, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_2 = registerItem("short_sword_plus_2", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 7, -2.4F, 1.0F, 0.5F, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(175)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_3 = registerItem("short_sword_plus_3", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 8, -2.4F, 1.0F, 0.5F, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(20)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_4 = registerItem("short_sword_plus_4", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 9, -2.4F, 1.0F, 0.5F, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(225)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_5 = registerItem("short_sword_plus_5", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 10, -2.4F, 1.0F, 0.5F, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(250)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_FIRE = registerItem("short_sword_fire", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_FIRE_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_FIRE_TWO_HANDED_DAMAGE_TYPE, 10, -2.4F, 1.0F, 0.5F, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(250)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SPEAR = registerItem("spear", new BasicWeaponItem(DamageTypesRegistry.SPEAR_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SPEAR_TWO_HANDED_DAMAGE_TYPE, 7, -3.0F, 1.5F, 1, 2, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item WAR_HAMMER = registerItem("war_hammer", new BasicWeaponItem(DamageTypesRegistry.WAR_HAMMER_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.WAR_HAMMER_TWO_HANDED_DAMAGE_TYPE, 8, -3.5F, 2, 1.25F, 4, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item ZWEIHANDER = registerItem("zweihander", new BasicWeaponItem(DamageTypesRegistry.ZWEIHANDER_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.ZWEIHANDER_TWO_HANDED_DAMAGE_TYPE, 8, -3.5F, 2, 1.25F, 4, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item DEFAULT_EMPTY_HAND_WEAPON = registerItem("default_empty_hand_weapon", new EmptyHandWeapon(DamageTypesRegistry.DEFAULT_UNARMED_DAMAGE_TYPE, 1, -2.0F, 0.25F, new Item.Settings()), null);
