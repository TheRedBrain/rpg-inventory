...
public class ItemRegistry {
    ...
    public static final Item BATTLE_AXE = registerItem("battle_axe", new BasicWeaponItem(DamageTypesRegistry.BATTLE_AXE_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.BATTLE_AXE_TWO_HANDED_DAMAGE_TYPE, 8, -3.5F, 8, 5, 4, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(336)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item CLAW = registerItem("claw", new BasicWeaponItem(DamageTypesRegistry.CLAW_DAMAGE_TYPE, 3, -2.0F, 2, 1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(336)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item DAGGER = registerItem("dagger", new BasicWeaponItem(DamageTypesRegistry.DAGGER_DAMAGE_TYPE, 3, -2.0F, 2, 1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(336)), ItemGroupRegistry.BAM_EQUIPMENT);
    // TODO knuckles
    public static final Item HALBERD = registerItem("halberd", new BasicWeaponItem(DamageTypesRegistry.HALBERD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.HALBERD_TWO_HANDED_DAMAGE_TYPE, 7, -3.0F, 7, 4, 3, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(336)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item LONG_SWORD = registerItem("long_sword", new BasicWeaponItem(DamageTypesRegistry.LONG_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.LONG_SWORD_TWO_HANDED_DAMAGE_TYPE, 5, -2.4F, 5, 2, 2, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(336)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item MACE = registerItem("mace", new BasicWeaponItem(DamageTypesRegistry.MACE_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.MACE_TWO_HANDED_DAMAGE_TYPE, 5, -2.4F, 4, 2, 2, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(336)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD = registerItem("short_sword", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 5, -2.4F, 4, 2, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(336)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SPEAR = registerItem("spear", new BasicWeaponItem(DamageTypesRegistry.SPEAR_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SPEAR_TWO_HANDED_DAMAGE_TYPE, 7, -3.0F, 6, 4, 2, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(336)), ItemGroupRegistry.BAM_EQUIPMENT);
