...
public class ItemRegistry {
    ...
    public static final Item BATTLE_AXE = registerItem("battle_axe", new BasicWeaponItem(DamageTypesRegistry.BATTLE_AXE_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.BATTLE_AXE_TWO_HANDED_DAMAGE_TYPE, 8, -3.5F, 8, 5, 4, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item CLAW = registerItem("claw", new BasicWeaponItem(DamageTypesRegistry.CLAW_DAMAGE_TYPE, 3, -2.0F, 2, 1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item DAGGER = registerItem("dagger", new BasicWeaponItem(DamageTypesRegistry.DAGGER_DAMAGE_TYPE, 3, -2.0F, 2, 1, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    // TODO knuckles
    public static final Item HALBERD = registerItem("halberd", new BasicWeaponItem(DamageTypesRegistry.HALBERD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.HALBERD_TWO_HANDED_DAMAGE_TYPE, 7, -3.0F, 7, 4, 3, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item LONG_SWORD = registerItem("long_sword", new BasicWeaponItem(DamageTypesRegistry.LONG_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.LONG_SWORD_TWO_HANDED_DAMAGE_TYPE, 5, -2.4F, 5, 2, 2, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item MACE = registerItem("mace", new BasicWeaponItem(DamageTypesRegistry.MACE_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.MACE_TWO_HANDED_DAMAGE_TYPE, 5, -2.4F, 4, 2, 2, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD = registerItem("short_sword", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 5, -2.4F, 4, 2, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_1 = registerItem("short_sword_plus_1", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 6, -2.4F, 4, 2, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_2 = registerItem("short_sword_plus_2", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 7, -2.4F, 4, 2, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(175)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_3 = registerItem("short_sword_plus_3", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 8, -2.4F, 4, 2, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(20)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_4 = registerItem("short_sword_plus_4", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 9, -2.4F, 4, 2, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(225)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_PLUS_5 = registerItem("short_sword_plus_5", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_TWO_HANDED_DAMAGE_TYPE, 10, -2.4F, 4, 2, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(250)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SHORT_SWORD_FIRE = registerItem("short_sword_fire", new BasicWeaponItem(DamageTypesRegistry.SHORT_SWORD_FIRE_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SHORT_SWORD_FIRE_TWO_HANDED_DAMAGE_TYPE, 10, -2.4F, 4, 2, 1.5F, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(250)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item SPEAR = registerItem("spear", new BasicWeaponItem(DamageTypesRegistry.SPEAR_ONE_HANDED_DAMAGE_TYPE, DamageTypesRegistry.SPEAR_TWO_HANDED_DAMAGE_TYPE, 7, -3.0F, 6, 4, 2, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,  new Item.Settings().maxDamage(150)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item DEFAULT_EMPTY_HAND_WEAPON = registerItem("default_empty_hand_weapon", new EmptyHandWeapon(DamageTypesRegistry.DEFAULT_UNARMED_DAMAGE_TYPE, 1, -2.0F, 1, new Item.Settings()), null);
