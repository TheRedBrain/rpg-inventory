...
//    public static final Item ZWEIHANDER = registerItem("zweihander", new BetterAdventureMode_BasicWeaponItem(DamageTypes.PLAYER_ATTACK, DamageTypes.PLAYER_ATTACK,7, -3.5F, 5, 5,  new Item.Settings().maxDamage(336)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item STONE_SWORD = registerItem("stone_sword", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,4, -2.4F, 1, 3,  new Item.Settings().maxDamage(100)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item GOLDEN_SWORD = registerItem("golden_sword", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,3, -2.4F, 1, 4,  new Item.Settings().maxDamage(50)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item IRON_SWORD = registerItem("iron_sword", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,5, -2.4F, 1, 3,  new Item.Settings().maxDamage(200)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item DIAMOND_SWORD = registerItem("diamond_sword", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,6, -2.4F, 2, 3,  new Item.Settings().maxDamage(250)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item NETHERITE_SWORD = registerItem("netherite_sword", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,7, -2.4F, 2, 3,  new Item.Settings().maxDamage(300)), ItemGroupRegistry.BAM_EQUIPMENT);

    public static final Item WOODEN_PICKAXE = registerItem("wooden_pickaxe", new BasicWeaponItem(DamageTypesRegistry.PIERCING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,3, -2.8F, 1, 1,  new Item.Settings().maxDamage(50)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item STONE_PICKAXE = registerItem("stone_pickaxe", new BasicWeaponItem(DamageTypesRegistry.PIERCING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,4, -2.8F, 1, 3,  new Item.Settings().maxDamage(100)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item GOLDEN_PICKAXE = registerItem("golden_pickaxe", new BasicWeaponItem(DamageTypesRegistry.PIERCING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,3, -2.8F, 1, 4,  new Item.Settings().maxDamage(50)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item IRON_PICKAXE = registerItem("iron_pickaxe", new BasicWeaponItem(DamageTypesRegistry.PIERCING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,5, -2.8F, 1, 3,  new Item.Settings().maxDamage(200)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item DIAMOND_PICKAXE = registerItem("diamond_pickaxe", new BasicWeaponItem(DamageTypesRegistry.PIERCING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,6, -2.8F, 2, 3,  new Item.Settings().maxDamage(250)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item NETHERITE_PICKAXE = registerItem("netherite_pickaxe", new BasicWeaponItem(DamageTypesRegistry.PIERCING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE,7, -2.8F, 2, 3,  new Item.Settings().maxDamage(300)), ItemGroupRegistry.BAM_EQUIPMENT);

    public static final Item WOODEN_AXE = registerItem("wooden_axe", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.SLASHING_DAMAGE_TYPE,3, -3.0F, 1, 1,  new Item.Settings().maxDamage(50)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item STONE_AXE = registerItem("stone_axe", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.SLASHING_DAMAGE_TYPE,4, -3.0F, 1, 3,  new Item.Settings().maxDamage(100)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item GOLDEN_AXE = registerItem("golden_axe", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.SLASHING_DAMAGE_TYPE,3, -3.0F, 1, 4,  new Item.Settings().maxDamage(50)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item IRON_AXE = registerItem("iron_axe", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.SLASHING_DAMAGE_TYPE,5, -3.0F, 1, 3,  new Item.Settings().maxDamage(200)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item DIAMOND_AXE = registerItem("diamond_axe", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.SLASHING_DAMAGE_TYPE,6, -3.0F, 2, 3,  new Item.Settings().maxDamage(250)), ItemGroupRegistry.BAM_EQUIPMENT);
    public static final Item NETHERITE_AXE = registerItem("netherite_axe", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.SLASHING_DAMAGE_TYPE,7, -3.0F, 2, 3,  new Item.Settings().maxDamage(300)), ItemGroupRegistry.BAM_EQUIPMENT);
    ...
    public static final Item TEST_SWORD = registerItem("test_sword", new BasicWeaponItem(DamageTypesRegistry.SLASHING_DAMAGE_TYPE, DamageTypesRegistry.PIERCING_DAMAGE_TYPE, 4, -3.0F, 3, 2, new FabricItemSettings().maxDamage(336)), ItemGroups.OPERATOR);
