...
import com.github.theredbrain.rpgmod.RPGModClient;
import com.github.theredbrain.rpgmod.client.render.renderer.CustomModeledVanillaArmorRenderer;
...
public class PlayerSkinArmorItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);

    public PlayerSkinArmorItem(Settings settings) {
...
//                }
                if (textureIdentifier == null) {
                    textureIdentifier = new Identifier(RPGMod.MOD_ID, "textures/item/armor/centaur_upper_body.png");
                }
//                else {
...
//                }
                ...
                if(this.renderer == null) {
                    this.renderer = new PlayerSkinArmorRenderer(new Identifier(RPGMod.MOD_ID, "armor/player_skin_model"), textureIdentifier);
                }
