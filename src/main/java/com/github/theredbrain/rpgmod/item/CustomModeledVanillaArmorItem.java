...
public class CustomModeledVanillaArmorItem extends CustomArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);
    private final Identifier assetSubpath;
    private final TagKey<Item> armorSet;
    public CustomModeledVanillaArmorItem(ArmorMaterial material, EquipmentSlot slot, TagKey<Item> armorSet, Identifier assetSubpath, Settings settings) {
        ...
        consumer.accept(new RenderProvider() {
            ...
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, BipedEntityModel<LivingEntity> original) {
                if(this.renderer == null)
                    this.renderer = new CustomModeledVanillaArmorRenderer(assetSubpath);
