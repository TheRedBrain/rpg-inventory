...
import com.github.theredbrain.rpgmod.client.render.model.NoLegsPlayerSkinArmorModel;
...
public class NoLegsPlayerSkinArmorRenderer extends GeoArmorRenderer<NoLegsPlayerSkinArmorItem> {
    ...
    public NoLegsPlayerSkinArmorRenderer(Identifier assetSubpath, Identifier playerSkinTexture) {
        super(((DuckDefaultedGeoModelMixin<NoLegsPlayerSkinArmorItem>)new NoLegsPlayerSkinArmorModel(assetSubpath)).withCustomTexture(playerSkinTexture));
    }
     ...
     */
    @Override
    public RenderLayer getRenderType(NoLegsPlayerSkinArmorItem animatable, Identifier texture, @org.jetbrains.annotations.Nullable VertexConsumerProvider bufferSource, float partialTick) {
