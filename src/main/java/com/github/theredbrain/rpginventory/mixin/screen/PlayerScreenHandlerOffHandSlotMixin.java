...
public abstract class PlayerScreenHandlerOffHandSlotMixin extends Slot {
    ...
    public boolean canInsert(ItemStack stack) {
        ...
        return stack.isIn(Tags.OFF_HAND_ITEMS) && (hasCivilisationEffect || this.field_42464.isCreative() || (bl && !hasWildernessEffect)) && !((DuckPlayerEntityMixin)this.field_42464).rpginventory$isOffHandStackSheathed();
    }
}
