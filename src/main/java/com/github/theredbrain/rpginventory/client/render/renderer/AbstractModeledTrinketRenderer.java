...
public abstract class AbstractModeledTrinketRenderer<T extends Item & GeoItem> extends BipedEntityModel implements GeoRenderer<T> {
    ...
    public AbstractModeledTrinketRenderer(GeoModel<T> model) {
     ...
     */
    public AbstractModeledTrinketRenderer<T> addRenderLayer(GeoRenderLayer<T> renderLayer) {
     ...
     */
    public AbstractModeledTrinketRenderer<T> withScale(float scale) {
     ...
     * Sets a scale override for this renderer, telling AzureLib to pre-scale the model
     */
    public AbstractModeledTrinketRenderer<T> withScale(float scaleWidth, float scaleHeight) {
