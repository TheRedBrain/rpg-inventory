...
import com.github.theredbrain.rpginventory.effect.*;
...
//            .addAttributeModifier(EntityAttributesRegistry.HEALTH_REGENERATION, AttributeModifierUUIDs.CIVILISATION_EFFECT, 5.0F, EntityAttributeModifier.Operation.ADDITION)
    ...
    public static void registerEffects() {
        ...
        Registry.register(Registries.STATUS_EFFECT, RPGInventory.identifier("civilisation_effect"), CIVILISATION_EFFECT);
        Registry.register(Registries.STATUS_EFFECT, RPGInventory.identifier("wilderness_effect"), WILDERNESS_EFFECT);
        Registry.register(Registries.STATUS_EFFECT, RPGInventory.identifier("needs_two_handing_effect"), NEEDS_TWO_HANDING_EFFECT);
        Registry.register(Registries.STATUS_EFFECT, RPGInventory.identifier("no_attack_items_effect"), NO_ATTACK_ITEMS_EFFECT);

        Registry.register(Registries.STATUS_EFFECT, RPGInventory.identifier("overburdened_effect"), OVERBURDENED_EFFECT);
    }
}
