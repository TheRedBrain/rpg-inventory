...
public class RelayTriggerBlockBlockEntity extends BlockEntity implements Triggerable {
...
//            nbt.putInt("triggeredBlockTriggerDelay_" + i, triggeredBlock.getSecond());
        }
    }
...
//            int delay = MathHelper.clamp(nbt.getInt("triggeredBlockTriggerDelay_" + i), 0, 120); // TODO test if delay is small enough
