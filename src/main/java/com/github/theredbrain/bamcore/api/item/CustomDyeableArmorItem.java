...
public class CustomDyeableArmorItem extends DyeableArmorItem implements CustomArmour {
    ...
    public CustomDyeableArmorItem(int poise, int weight, ArmorMaterial armorMaterial, Type type, Item.Settings settings) {
        ...
        builder.put(BetterAdventureModeCoreEntityAttributes.EQUIPMENT_WEIGHT, new EntityAttributeModifier(uUID, "Equipment weight", (double)this.weight, EntityAttributeModifier.Operation.ADDITION));
        builder.put(BetterAdventureModeCoreEntityAttributes.MAX_POISE, new EntityAttributeModifier(uUID, "Poise", (double)this.poise, EntityAttributeModifier.Operation.ADDITION));
