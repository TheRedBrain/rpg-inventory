...
public class StatusEffectsRegistry {
    ...
    public static final StatusEffect OVERBURDENED_EFFECT = new OverburdenedStatusEffect().addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, AttributeModifierUUIDs.OVERBURDENED_EFFECT, 0.5, EntityAttributeModifier.Operation.MULTIPLY_TOTAL);
