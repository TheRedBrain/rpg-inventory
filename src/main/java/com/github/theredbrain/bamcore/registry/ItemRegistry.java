...
public class ItemRegistry {
    ...
    public static final Item TEST_AURA_NECKLACE = registerItem("test_aura_necklace", new AuraGrantingNecklaceTrinketItem((AuraStatusEffect) BetterAdventureModeCoreStatusEffects.TEST_AURA_EFFECT, new FabricItemSettings().maxCount(1)), ItemGroups.COMBAT);
