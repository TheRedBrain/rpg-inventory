 ...
 */
package com.github.theredbrain.bamcore.render.block.entity;
...
//        }
    ...
    private void renderInvisibleBlocks(TeleporterBlockBlockEntity entity, VertexConsumer vertices, BlockPos pos, MatrixStack matrices) {
        ...
        for (BlockPos blockPos3 : BlockPos.iterate(blockPos2, blockPos2.add(entity.getActivationAreaDimensions()).add(-1, -1, -1))) {
            boolean bl5;
