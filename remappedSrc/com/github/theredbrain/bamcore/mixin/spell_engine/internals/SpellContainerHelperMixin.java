...
public abstract class SpellContainerHelperMixin {
    ...
    public static SpellContainer containerWithProxy(SpellContainer proxyContainer, PlayerEntity player) {
        ...
        if (proxyContainer != null && proxyContainer.is_proxy && component.isPresent()) {
            ...
            if (((DuckSpellContainerMixin) proxyContainer).getProxyPool() != null && !(((DuckSpellContainerMixin) proxyContainer).getProxyPool().isEmpty())) {
                validSpellPool = SpellRegistry.spellPool(new Identifier(((DuckSpellContainerMixin) proxyContainer).getProxyPool()));
            }
